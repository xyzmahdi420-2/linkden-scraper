...
# ============================================================================
# CONSTANTS & REGEX PATTERNS (Compiled once for performance)
# ============================================================================

COUNTRY_CODES = {
    'United States': 'US', 'Canada': 'CA', 'United Kingdom': 'GB', 'India': 'IN',
    'Bangladesh': 'BD', 'Australia': 'AU', 'Germany': 'DE', 'France': 'FR',
    'Brazil': 'BR', 'China': 'CN', 'Japan': 'JP', 'Singapore': 'SG',
    'Netherlands': 'NL', 'Sweden': 'SE', 'Switzerland': 'CH', 'Ireland': 'IE',
    'Israel': 'IL', 'South Korea': 'KR', 'Spain': 'ES', 'Italy': 'IT',
    'Mexico': 'MX', 'UAE': 'AE', 'Saudi Arabia': 'SA', 'Pakistan': 'PK',
            'Indonesia': 'ID', 'Philippines': 'PH', 'Thailand': 'TH', 'Vietnam': 'VN',
            'Nigeria': 'NG', 'Kenya': 'KE', 'South Africa': 'ZA', 'Egypt': 'EG',
            'Turkey': 'TR', 'Poland': 'PL', 'Ukraine': 'UA', 'Romania': 'RO',
            'Czech Republic': 'CZ', 'Hungary': 'HU', 'Austria': 'AT', 'Belgium': 'BE',
            'Denmark': 'DK', 'Finland': 'FI', 'Norway': 'NO', 'New Zealand': 'NZ',
            'Argentina': 'AR', 'Chile': 'CL', 'Colombia': 'CO', 'Peru': 'PE',
            'Malaysia': 'MY', 'Taiwan': 'TW', 'Hong Kong': 'HK', 'Russia': 'RU',
...
# Static IDs (update these if LinkedIn changes them)
